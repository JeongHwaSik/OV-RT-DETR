...
https://github.com/AILab-CVC/YOLO-World/blob/master/yolo_world/models/backbones/mm_backbone.py
"""
...
if __name__ == '__main__':
    ...
    # load_text = RandomLoadText(
    #     text_path='obj365v1_class_texts.json',
    #     prompt_format='{}',
