...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        target['text'] = list(mscoco_category2name.values())  # TODO: differences b/t obj365v1_class_texts.json
...
# 80 categories for COCO object detection
...
if __name__ == '__main__':
    ...
    coco_ds = CocoDetection(img_folder, ann_file, transforms, return_masks, remap_mscoco_category)
