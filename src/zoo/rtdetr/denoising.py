...
def get_contrastive_denoising_training_group(targets,
    ...
    input_query_class = input_query_class.tile([1, 2 * num_group]) # 2 for pos & neg
    ...
    if box_noise_scale > 0:
        ...
        diff = torch.tile(input_query_bbox[..., 2:] * 0.5, [1, 1, 2]) * box_noise_scale # noise
        rand_sign = torch.randint_like(input_query_bbox, 0, 2) * 2.0 - 1.0 # -1 or +1 for directioin of the noise
